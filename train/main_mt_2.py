...
#                          'then other options')
parser.add_argument('--load', default=r'data/cif_data')
parser.add_argument('--file',default='id_prop.csv')
...
parser.add_argument('--load_embedding_only', default=False)
...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        print(mae_error,r2_score,mae_error2,r2_score2)
